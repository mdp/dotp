...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dotpCrypt = __webpack_require__(502);
	...
	var QRCode = __webpack_require__(518);
	...
	var OpenInAppButton = function (_React$Component) {
	  _inherits(OpenInAppButton, _React$Component);

	  function OpenInAppButton() {
	    _classCallCheck(this, OpenInAppButton);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(OpenInAppButton).apply(this, arguments));
	  }

	  _createClass(OpenInAppButton, [{
	    key: 'isMobile',
	      ...
	      if (this.isMobile()) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: 'https://dauth.atrailing.space/' + this.props.challenge },
	            'Open in App'
	          )
	        );
	      }
	...
	var Challenger = function (_React$Component2) {
	  _inherits(Challenger, _React$Component2);

	  function Challenger(p, c) {
	    _classCallCheck(this, Challenger);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Challenger).call(this, p, c));

	    _this2.state = _this2.fetchInitialState();
	    return _this2;
	  }
	  ...
	  _createClass(Challenger, [{
	    ...
	    value: function fetchInitialState() {
	      ...
	      var ephemeralKey = new Uint8Array(32);
	      crypto.getRandomValues(ephemeralKey);
	      var recPublicId = this.props.routeParams.keyId;
	      var otp = this._getRandomOTP(9);
	      var challenge = _dotpCrypt2.default.createChallenge(otp, recPublicId, serverName, ephemeralKey);
	      return {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(OpenInAppButton, { props: { challenge: this.state.challenge } })
	        ),
	        _react2.default.createElement(
	          'div',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(498); if (makeExportsHot(module, __webpack_require__(258))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Challenger.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
