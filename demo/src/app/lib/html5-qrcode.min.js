...
var DataMask={forReference:function(d){if(0>d||7<d)throw"System.ArgumentException";return DataMask.DATA_MASKS[d]}};function DataMask000(){this.unmaskBitMatrix=function(d,a){for(var c=0;c<a;c++)for(var b=0;b<a;b++)this.isMasked(c,b)&&d.flip(b,c)};this.isMasked=function(d,a){return 0==(d+a&1)}}function DataMask001(){this.unmaskBitMatrix=function(d,a){for(var c=0;c<a;c++)for(var b=0;b<a;b++)this.isMasked(c,b)&&d.flip(b,c)};this.isMasked=function(d){return 0==(d&1)}}
...
GF256.DATA_MATRIX_FIELD=new GF256(301);GF256.addOrSubtract=function(d,a){return d^a};var Decoder={};Decoder.rsDecoder=new ReedSolomonDecoder(GF256.QR_CODE_FIELD);Decoder.correctErrors=function(d,a){for(var c=d.length,b=Array(c),e=0;e<c;e++)b[e]=d[e]&255;c=d.length-a;try{Decoder.rsDecoder.decode(b,c)}catch(g){throw g;}for(e=0;e<a;e++)d[e]=b[e]};
