...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dotpCrypt = __webpack_require__(506);
	...
	var QRCode = __webpack_require__(514);
	...
	var Challenger = function (_React$Component) {
	  ...
	  function Challenger(p, c) {
	    ...
	    _this.state = _this.fetchInitialState();
	    return _this;
	  }
	  ...
	  _createClass(Challenger, [{
	    ...
	    value: function fetchInitialState() {
	      ...
	      var challenge = _dotpCrypt2.default.createChallenge(new Buffer(otp), recPublicId, ephemeralKey);
	      return {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(195)(module), __webpack_require__(502).Buffer))
