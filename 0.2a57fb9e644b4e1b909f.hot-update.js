...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerSecret = new Buffer('This is the seed for the server secret key');
	console.log(_dotpCrypt2.default.nacl.hash(ServerSecret));
	var ServerPrivateKey = _dotpCrypt2.default.nacl.hash(ServerSecret).subarray(0, 32);
	var ServerKeyPair = _dotpCrypt2.default.getKeyPair(ServerPrivateKey);
	var OTPCharSet = '023456789abcdefghjkmnpqrstuvwxyz';
	...
	var Challenger = function (_React$Component) {
	  ...
	  _createClass(Challenger, [{
	    ...
	    value: function getInitialState() {
	      ...
	      var nonce = new Uint8Array(24);window.crypto.getRandomValues(nonce);
	      var expiresAt = Math.floor(Date.now() / 1000) + 360;
	      var otp = this._getRandomOTP(10);
	      var challenge = _dotpCrypt2.default.createChallenge(new Buffer(otp), nonce, expiresAt, ServerKeyPair, recPublicId);
	      return {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'form',
	                { onSubmit: this._checkOTP.bind(this) },
	                _react2.default.createElement(
	                  'div',
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'td',
	                      null,
	                      _dotpCrypt2.default.utils.Base58.encode(this.state.nonce)
	                    )
	                  ),
	                  _react2.default.createElement(
	                    'tr',
	                    ...
	                    _react2.default.createElement(
	                      'td',
	                      null,
	                      new Date(this.state.expiresAt * 1000).toString()
	                    )
	                  )
	                )
	              )
